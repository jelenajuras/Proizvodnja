...
<div class="row">
	<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
		<div class="table-responsive">
			<table id="table_id" class="display user1">
				<thead>
					<tr>
						<th>Avatar</th>
						<th>Full name</th>
					...
					@foreach ($users as $user)
						...
						<tr class="user">
							...
							<td>
								...
								@if(is_file('storage/photos/' . $user->last_name . ' ' . $user->first_name . '.png'))<img src="{{ asset('storage/photos/' . $user->last_name . ' ' . $user->first_name . '.png' ) }}" alt="avatar">
								@elseif(is_file('storage/photos/' . $user->last_name . ' ' . $user->first_name . '.jpg'))<img src="{{ asset('storage/photos/' . $user->last_name . ' ' . $user->first_name . '.jpg' ) }}" alt="avatar">
								@elseif(is_file('storage/photos/' . $user->last_name . ' ' . $user->first_name . '.jpeg'))<img src="{{ asset('storage/photos/' . $user->last_name . ' ' . $user->first_name . '.jpg' ) }}" alt="avatar">
								@elseif(is_file('storage/photos/' . $user->last_name . ' ' . $user->first_name . '.gif'))<img src="{{ asset('storage/photos/' . $user->last_name . ' ' . $user->first_name . '.gif' ) }}" alt="avatar">
								@endif
							</td>
