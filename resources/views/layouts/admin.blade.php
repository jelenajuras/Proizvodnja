            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                    <ul class="nav navbar-nav">
						...
						<li class="{{ Request::is('admin/comments*') ? 'active' : '' }}"><a href="#">Comments <span class="badge">{{ DB::table('comments')->where('user_id', Sentinel::getUser()->id)->where('status','0')->count() }}</span></a></li>
                    </ul>
